...
class PunchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create punch" do
    assert_difference('Punch.count') do
      post punches_url, params: { punch: { punch_at: @punch.punch_at, punch_type: @punch.punch_type, user_id: @punch.user_id } }
    end
  ...
  test "should update punch" do
    patch punch_url(@punch), params: { punch: { punch_at: @punch.punch_at, punch_type: @punch.punch_type, user_id: @punch.user_id } }
